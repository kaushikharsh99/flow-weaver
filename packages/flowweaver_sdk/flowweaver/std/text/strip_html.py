...
def strip_html(dataset: Dataset, column: str) -> Dataset:
    """Strips HTML tags and entities from string values in column."""
    ...
    return res.with_history("strip_html", column=column)
